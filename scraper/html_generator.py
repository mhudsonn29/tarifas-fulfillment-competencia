...
def generate_html(
    falabella_data: dict[str, Any] = None,
    mercadolibre_data: dict[str, Any] = None,
    paris_data: dict[str, Any] = None,
    output_dir: str = "docs"
) -> str:
...
<head>
    ...
    <style>
        .btn-green {{ @apply inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition font-medium; }}
        .btn-yellow {{ @apply inline-flex items-center px-4 py-2 bg-yellow-500 text-gray-900 rounded-lg hover:bg-yellow-600 transition font-medium; }}
        .btn-blue {{ @apply inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium; }}
    </style>
</head>
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="mb-8 p-4 rounded-lg bg-green-100 border border-green-300">
            <p class="font-medium">✅ Página disponible - Haz clic en los botones para ver las tarifas actualizadas</p>
        </div>
        ...
        <!-- WALMART WFS -->
        <section class="mb-12 bg-white rounded-lg shadow-md p-6 border-l-4" style="border-color:#0053e2">
            <h2 class="text-2xl font-bold mb-4 flex items-center" style="color:#0053e2">
                <span class="mr-2">🔷</span> Walmart Fulfillment Services (WFS)
            </h2>
            <div class="mb-4">
                <a href="https://marketplacelearn.walmart.com/cl/guides/Walmart%20Fulfillment%20Services/Walmart%20Fulfillment%20Services/tarifas-wfs"
                   target="_blank"
                   class="inline-flex items-center px-4 py-2 text-white rounded-lg font-medium transition"
                   style="background-color:#0053e2;" onmouseover="this.style.backgroundColor='#0046c0'" onmouseout="this.style.backgroundColor='#0053e2'">
                    🔗 Ver tarifas de Fulfillment en Walmart
                </a>
                <p class="text-sm text-gray-500 mt-2">Incluye tarifas de fulfillment por unidad vendida, retiro de mercadería, almacenamiento diario y compensación por mermas.</p>
            </div>
        </section>
    ...
    <footer class="bg-gray-800 text-white py-6">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-sm text-gray-400 mt-1">Actualizado cada 48 horas vía GitHub Actions</p>
        </div>
    </footer>
</body>
</html>
